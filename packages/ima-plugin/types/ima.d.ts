...
export namespace google {
  ...
  namespace ima {
    ...
    namespace AdEvent {
      ...
      enum Type {
        /**
         * Fired when the ad has loaded and is ready to play.
         */
    ...
    class AdsRequest {
      /**
       * The OM SDK supports running verification scripts in different access modes, which control how much the verification script can access. Access mode rules must be set at the ad-request level. To set different access modes for different verification script providers, pass a dictionary that maps each OmidVerificationVendor to one of the access mode
       *
       * See: https://developers.google.com/interactive-media-ads/docs/sdks/html5/open-measurement
       *
       * This parameter is optional.
       */
      public omidAccessModeRules?: OmidAccessModeRules
      /**
