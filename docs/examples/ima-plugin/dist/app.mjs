...
const Ut = (e) => {
  ...
  var r, l, h, p, s, i, c, a, d, o, u;
  const n = (s = (p = (h = (l = (r = e.requestFullscreen) != null ? r : e.webkitRequestFullscreen) != null ? l : e.webkitEnterFullscreen) != null ? h : e.mozRequestFullScreen) != null ? p : e.msRequestFullscreen) != null ? s : null, m = (u = (o = (d = (a = (c = (i = t.requestFullscreen) != null ? i : t.webkitRequestFullscreen) != null ? c : t.webkitEnterFullscreen) != null ? a : t.requestFullscreen) != null ? d : t.mozRequestFullScreen) != null ? o : t.msRequestFullscreen) != null ? u : null;
  n !== null ? n.apply(e) : m !== null && m.apply(t);
}, qt = (e) => {
  var t, r, l, h, p;
  const s = document, i = (h = (l = (r = (t = s.exitFullscreen) != null ? t : s.webkitExitFullscreen) != null ? r : s.mozCancelFullScreen) != null ? l : s.msExitFullscreen) != null ? h : null, c = (p = e.webkitExitFullscreen) != null ? p : null;
  i !== null ? i.apply(s) : c !== null && c.apply(e);
}, q = (e) => {
  const t = [];
  t.push(["role", "presentation"]), t.push(["focusable", "false"]);
  const r = "http://www.w3.org/2000/svg", l = "#cheza-", h = document.createElementNS(r, "svg");
  t.forEach((i) => {
    h.setAttribute(i[0], i[1]);
  });
  const p = document.createElementNS(r, "use"), s = l + e;
  ...
  ["fullscreenchange", "webkitfullscreenchange", "mozfullscreenchange", "MSFullscreenChange"].forEach((l) => {
  ...
  const { videoElement: r } = t, { offsetX: l } = e, { offsetWidth: h } = t.progressContainer, p = l / h;
  t.progress.style.width = `${p * 100}%`, r.currentTime = r.duration * p;
}, Qt = (e) => {
  Zt();
  const t = e.videoElement.parentElement, r = e.rootElement, l = e.uiRoot;
  r.classList.add("cheza"), l.classList.add("default-ui"), t.insertBefore(r, e.videoElement), r.appendChild(e.videoElement);
  const h = document.createElement("div");
  h.classList.add("animation"), e.loadingSpinner.classList.add("loading-spinner", "hidden"), e.loadingSpinner.appendChild(h), l.appendChild(e.loadingSpinner), e.controlsTop.classList.add("controls-top"), e.controlsBottom.classList.add("controls-bottom"), e.progressContainer.classList.add("progress-container"), l.appendChild(e.controlsTop), l.appendChild(e.progressContainer), l.appendChild(e.controlsBottom);
  ...
  const t = document.createElement("div"), r = document.createElement("div"), l = document.createElement("div"), h = document.createElement("div"), p = document.createElement("div"), s = document.createElement("div"), i = document.createElement("div");
  return {
    rootElement: t,
    uiRoot: r,
    videoElement: e,
...
class U {
  constructor(t) {
    T(this, "_dataStore"), T(this, "getDataStore", () => this._dataStore), T(this, "addPlugin", (r, l) => {
      if (j.has(r) && !this._dataStore.activePlugins.has(r)) {
        const h = j.get(r), p = new h();
        return p.add(this._dataStore, l), this._dataStore.activePlugins.set(r, p), !0;
      }
      return !1;
    }), T(this, "removePlugin", (r, l) => j.has(r) && this._dataStore.activePlugins.has(r) ? (this._dataStore.activePlugins.get(r).remove(this._dataStore, l), this._dataStore.activePlugins.delete(r), !0) : !1), T(this, "getPlugin", (r) => {
...
const tr = async (e) => {
  ...
  return e === !0 && (t = "https://imasdk.googleapis.com/js/sdkloader/ima3_debug.js"), await new Promise((r, l) => {
  ...
  dispatch: (t, r) => {
    let l;
    r !== void 0 && (l = { detail: r });
    const h = new CustomEvent(`cheza:ima:${t}`, l);
    e.dispatchEvent(h);
  }
});
...
(function(e, t) {
  ...
  function l(h, p) {
    var s = p && p.loc, i = void 0, c = void 0, a = void 0, d = void 0;
    s && (i = s.start.line, c = s.end.line, a = s.start.column, d = s.end.column, h += " - " + i + ":" + a);
    for (var o = Error.prototype.constructor.call(this, h), u = 0; u < r.length; u++)
      this[r[u]] = o[r[u]];
    Error.captureStackTrace && Error.captureStackTrace(this, l);
    try {
      s && (this.lineNumber = i, this.endLineNumber = c, Object.defineProperty ? (Object.defineProperty(this, "column", {
        value: a,
        enumerable: !0
...
(function(e, t) {
  ...
  t.default = function(l) {
    l.registerHelper("blockHelperMissing", function(h, p) {
      ...
      if (h === !1 || h == null)
        return s(this);
      if (r.isArray(h))
        return h.length > 0 ? (p.ids && (p.ids = [p.name]), l.helpers.each(h, p)) : s(this);
      if (p.data && p.ids) {
        var c = r.createFrame(p.data);
        c.contextPath = r.appendContextPath(p.data.contextPath, p.name), p = { data: c };
      }
      return i(h, p);
    });
  }, e.exports = t.default;
...
(function(e, t) {
  ...
  var l = x, h = R.exports, p = r(h);
  t.default = function(s) {
    s.registerHelper("each", function(i, c) {
      if (!c)
        throw new p.default("Must pass iterator to #each");
      var a = c.fn, d = c.inverse, o = 0, u = "", n = void 0, m = void 0;
      c.data && c.ids && (m = l.appendContextPath(c.data.contextPath, c.ids[0]) + "."), l.isFunction(i) && (i = i.call(this)), c.data && (n = l.createFrame(c.data));
      function f(g, S, E) {
        n && (n.key = g, n.index = S, n.first = S === 0, n.last = !!E, m && (n.contextPath = m + g)), u = u + a(i[g], {
          data: n,
          blockParams: l.blockParams([i[g], g], [m + g, null])
        });
      }
...
(function(e, t) {
  ...
  var l = x, h = R.exports, p = r(h);
  t.default = function(s) {
    s.registerHelper("if", function(i, c) {
      if (arguments.length != 2)
        throw new p.default("#if requires exactly one argument");
      return l.isFunction(i) && (i = i.call(this)), !c.hash.includeZero && !i || l.isEmpty(i) ? c.inverse(this) : c.fn(this);
    }), s.registerHelper("unless", function(i, c) {
      if (arguments.length != 2)
...
(function(e, t) {
  t.__esModule = !0, t.default = function(r) {
    r.registerHelper("log", function() {
      for (var l = [void 0], h = arguments[arguments.length - 1], p = 0; p < arguments.length - 1; p++)
        l.push(arguments[p]);
      var s = 1;
      h.hash.level != null ? s = h.hash.level : h.data && h.data.level != null && (s = h.data.level), l[0] = s, r.log.apply(r, l);
    });
  }, e.exports = t.default;
})(Re, Re.exports);
var Ie = { exports: {} };
(function(e, t) {
  t.__esModule = !0, t.default = function(r) {
    r.registerHelper("lookup", function(l, h, p) {
      return l && p.lookupProperty(l, h);
    });
  }, e.exports = t.default;
})(Ie, Ie.exports);
var De = { exports: {} };
(function(e, t) {
  ...
  var l = x, h = R.exports, p = r(h);
  t.default = function(s) {
    s.registerHelper("with", function(i, c) {
      if (arguments.length != 2)
        throw new p.default("#with requires exactly one argument");
      l.isFunction(i) && (i = i.call(this));
      var a = c.fn;
      if (l.isEmpty(i))
        return c.inverse(this);
      var d = c.data;
      return c.data && c.ids && (d = l.createFrame(c.data), d.contextPath = l.appendContextPath(c.data.contextPath, c.ids[0])), a(i, {
        data: d,
        blockParams: l.blockParams([i], [d && d.contextPath])
      });
    });
  }, e.exports = t.default;
})(De, De.exports);
...
(function(e, t) {
  ...
  var r = x;
  t.default = function(l) {
    l.registerDecorator("inline", function(h, p, s, i) {
      var c = h;
      return p.partials || (p.partials = {}, c = function(a, d) {
        var o = s.partials;
        s.partials = r.extend({}, o, p.partials);
        var u = h(a, d);
        return s.partials = o, u;
...
(function(e, t) {
  ...
  var r = x, l = {
    ...
    lookupLevel: function(h) {
      if (typeof h == "string") {
        var p = r.indexOf(l.methodMap, h.toLowerCase());
        p >= 0 ? h = p : h = parseInt(h, 10);
      }
      return h;
    },
    log: function(h) {
      if (h = l.lookupLevel(h), typeof console < "u" && l.lookupLevel(l.level) <= h) {
        var p = l.methodMap[h];
        console[p] || (p = "log");
        for (var s = arguments.length, i = Array(s > 1 ? s - 1 : 0), c = 1; c < s; c++)
          i[c - 1] = arguments[c];
...
function un(e, t) {
  ...
  var r = function() {
    ...
    return arguments[arguments.length - 1] = t(l), e.apply(this, arguments);
  };
  return r;
}
H.__esModule = !0;
...
function fn(e) {
  ...
  if (!(t >= F.LAST_COMPATIBLE_COMPILER_REVISION && t <= F.COMPILER_REVISION))
    if (t < F.LAST_COMPATIBLE_COMPILER_REVISION) {
      var l = F.REVISION_CHANGES[r], h = F.REVISION_CHANGES[t];
      throw new $.default("Template was precompiled with an older version of Handlebars than the current runtime. Please update your precompiler to a newer version (" + l + ") or downgrade your runtime to an older version (" + h + ").");
    } else
...
function gn(e, t) {
  ...
  function l(s, i, c) {
    c.hash && (i = B.extend({}, i, c.hash), c.ids && (c.ids[0] = !0)), s = t.VM.resolvePartial.call(this, s, i, c);
    var a = B.extend({}, c, {
      hooks: this.hooks,
      protoAccessControl: this.protoAccessControl
    }), d = t.VM.invokePartial.call(this, s, i, a);
    if (d == null && t.compile && (c.partials[c.name] = t.compile(s, e.compilerOptions, t), d = c.partials[c.name](i, a)), d != null) {
      if (c.indent) {
        for (var o = d.split(`
`), u = 0, n = o.length; u < n && !(!o[u] && u + 1 === n); u++)
          o[u] = c.indent + o[u];
        d = o.join(`
`);
      }
  ...
  var h = {
    ...
    lookupProperty: function(s, i) {
      var c = s[i];
      if (c == null || Object.prototype.hasOwnProperty.call(s, i) || Xe.resultIsAllowed(c, h.protoAccessControl, i))
        return c;
    },
    lookup: function(s, i) {
      for (var c = s.length, a = 0; a < c; a++) {
    ...
    programs: [],
    program: function(s, i, c, a, d) {
      var o = this.programs[s], u = this.fn(s);
      return i || d || a || c ? o = le(this, s, u, i, c, a, d) : o || (o = this.programs[s] = le(this, s, u)), o;
    },
    data: function(s, i) {
      for (; s && i--; )
        s = s._parent;
    ...
    mergeIfNeeded: function(s, i) {
      var c = s || i;
      return s && i && s !== i && (c = B.extend({}, i, s)), c;
    },
  ...
  function p(s) {
    ...
    p._setup(i), !i.partial && e.useData && (c = _n(s, c));
    var a = void 0, d = e.useBlockParams ? [] : void 0;
    e.useDepths && (i.depths ? a = s != i.depths[0] ? [s].concat(i.depths) : i.depths : a = [s]);
    function o(u) {
      return "" + e.main(h, u, h.helpers, h.partials, c, d, a);
    }
    return o = Et(e.main, o, h, i.depths || [], c, d), o(s, i);
  }
  ...
  }, p._child = function(s, i, c, a) {
    if (e.useBlockParams && !c)
      throw new $.default("must pass block params");
    if (e.useDepths && !a)
      throw new $.default("must pass parent depths");
    return le(h, s, e[s], i, 0, c, a);
  }, p;
}
function le(e, t, r, l, h, p, s) {
  function i(c) {
    var a = arguments.length <= 1 || arguments[1] === void 0 ? {} : arguments[1], d = s;
    return s && c != s[0] && !(c === e.nullContext && s[0] === null) && (d = [c].concat(s)), r(e, c, e.helpers, e.partials, a.data || l, p && [a.blockParams].concat(p), d);
  }
  return i = Et(r, i, e, s, l, p), i.program = t, i.depth = s ? s.length : 0, i.blockParams = h || 0, i;
}
function vn(e, t, r) {
...
function yn(e, t, r) {
  ...
  if (r.fn && r.fn !== bt && function() {
    ...
    h = r.data["partial-block"] = function(s) {
      ...
      return i.data = F.createFrame(i.data), i.data["partial-block"] = l, p(s, i);
...
function Et(e, t, r, l, h, p) {
  if (e.decorator) {
    var s = {};
    t = e.decorator(t, s, r, l && l[0], h, p, l), B.extend(t, s);
  }
  return t;
}
function Sn(e, t) {
...
function bn(e, t) {
  ...
  return mn.wrapHelper(e, function(l) {
    return B.extend({ lookupProperty: r }, l);
  });
}
var de = { exports: {} };
(function(e, t) {
  t.__esModule = !0, t.default = function(r) {
    var l = typeof Q < "u" ? Q : window, h = l.Handlebars;
    r.noConflict = function() {
      return l.Handlebars === r && (l.Handlebars = h), r;
    };
  }, e.exports = t.default;
})(de, de.exports);
(function(e, t) {
  ...
  var h = D, p = l(h), s = Be.exports, i = r(s), c = R.exports, a = r(c), d = x, o = l(d), u = H, n = l(u), m = de.exports, f = r(m);
  function y() {
...
(function(e, t) {
  ...
  var r = {
    helpers: {
      ...
      simpleId: function(l) {
        return l.parts.length === 1 && !r.helpers.scopedId(l) && !l.depth;
      }
    }
  };
  t.default = r, e.exports = t.default;
...
(function(e, t) {
  ...
  var r = function() {
    var l = {
      ...
      performAction: function(s, i, c, a, d, o, u) {
        var n = o.length - 1;
        switch (d) {
          case 1:
            return o[n - 1];
      ...
      parse: function(s) {
        var i = this, c = [0], a = [null], d = [], o = this.table, u = "", n = 0, m = 0;
...
Expecting ` + A.join(", ") + ", got '" + (this.terminals_[_] || _) + "'" : O = "Parse error on line " + (n + 1) + ": Unexpected " + (_ == 1 ? "end of input" : "'" + (this.terminals_[_] || _) + "'"), this.parseError(O, { text: this.lexer.match, token: this.terminals_[_] || _, line: this.lexer.yylineno, loc: f, expected: A });
          ...
          switch (g[0]) {
            case 1:
              c.push(_), a.push(this.lexer.yytext), d.push(this.lexer.yylloc), c.push(g[1]), _ = null, m = this.lexer.yyleng, u = this.lexer.yytext, n = this.lexer.yylineno, f = this.lexer.yylloc;
              break;
            case 2:
              if (w = this.productions_[g[1]][1], E.$ = a[a.length - w], E._$ = { first_line: d[d.length - (w || 1)].first_line, last_line: d[d.length - 1].last_line, first_column: d[d.length - (w || 1)].first_column, last_column: d[d.length - 1].last_column }, y && (E._$.range = [d[d.length - (w || 1)].range[0], d[d.length - 1].range[1]]), S = this.performAction.call(E, u, m, n, this.yy, g[1], a, d), typeof S < "u")
                return S;
              w && (c = c.slice(0, -1 * w * 2), a = a.slice(0, -1 * w), d = d.slice(0, -1 * w)), c.push(this.productions_[g[1]][0]), a.push(E.$), d.push(E._$), L = o[c[c.length - 2]][c[c.length - 1]], c.push(L);
              break;
            case 3:
              return !0;
          }
      ...
      var s = {
        ...
        unput: function(i) {
          ...
          return this.yylloc = {
            ...
            last_column: a ? (a.length === d.length ? this.yylloc.first_column : 0) + d[d.length - a.length].length - a[0].length : this.yylloc.first_column - c
...
` + c + "^";
        ...
        next: function() {
          ...
          for (var u = this._currentRules(), n = 0; n < u.length && (a = this._input.match(this.rules[u[n]]), !(a && (!c || a[0].length > c[0].length) && (c = a, d = n, !this.options.flex))); n++)
            ;
          ...
          }, this.yytext += c[0], this.match += c[0], this.matches = c, this.yyleng = this.yytext.length, this.options.ranges && (this.yylloc.range = [this.offset, this.offset += this.yyleng]), this._more = !1, this._input = this._input.slice(c[0].length), this.matched += c[0], i = this.performAction.call(this, this.yy, this, u[d], this.conditionStack[this.conditionStack.length - 1]), this.done && this._input && (this.done = !1), i || void 0) : this._input === "" ? this.EOF : this.parseError("Lexical error on line " + (this.yylineno + 1) + `. Unrecognized text.
` + this.showPosition(), { text: "", token: null, line: this.yylineno });
      ...
      return s.options = {}, s.performAction = function(i, c, a, d) {
        function o(u, n) {
          return c.yytext = c.yytext.substring(u, c.yyleng - n + u);
        }
        switch (a) {
          case 0:
...
(function(e, t) {
  ...
  p.prototype = {
    ...
    PartialBlockStatement: function(a) {
      c.call(this, a), this.acceptKey(a, "program");
    },
...
(function(e, t) {
  ...
  var l = fe.exports, h = r(l);
  function p() {
    var d = arguments.length <= 0 || arguments[0] === void 0 ? {} : arguments[0];
    this.options = d;
  }
  p.prototype = new h.default(), p.prototype.Program = function(d) {
    var o = !this.options.ignoreStandalone, u = !this.isRootSeen;
    this.isRootSeen = !0;
    for (var n = d.body, m = 0, f = n.length; m < f; m++) {
      var y = n[m], v = this.accept(y);
      if (v) {
        var _ = s(n, m, u), b = i(n, m, u), g = v.openStandalone && _, S = v.closeStandalone && b, E = v.inlineStandalone && _ && b;
        v.close && c(n, m, !0), v.open && a(n, m, !0), o && E && (c(n, m), a(n, m) && y.type === "PartialStatement" && (y.indent = /([ \t]+$)/.exec(n[m - 1].original)[1])), o && g && (c((y.program || y.inverse).body), a(n, m)), o && S && (c(n, m), a((y.inverse || y.program).body));
      }
    }
    return d;
    ...
    var o = d.program || d.inverse, u = d.program && d.inverse, n = u, m = u;
    if (u && u.chained)
      for (n = u.body[0].program; m.chained; )
    ...
    if (d.openStrip.close && c(o.body, null, !0), u) {
      var y = d.inverseStrip;
      y.open && a(o.body, null, !0), y.close && c(n.body, null, !0), d.closeStrip.open && a(m.body, null, !0), !this.options.ignoreStandalone && s(o.body) && i(n.body) && (a(o.body), c(n.body));
    } else
  ...
  function c(d, o, u) {
    ...
    if (!(!n || n.type !== "ContentStatement" || !u && n.rightStripped)) {
      var m = n.value;
      n.value = n.value.replace(u ? /^\s+/ : /^[ \t]*\r?\n?/, ""), n.rightStripped = n.value !== m;
    }
  }
  function a(d, o, u) {
    var n = d[o == null ? d.length - 1 : o - 1];
    if (!(!n || n.type !== "ContentStatement" || !u && n.leftStripped)) {
      var m = n.value;
      return n.value = n.value.replace(u ? /\s+$/ : /[ \t]+$/, ""), n.leftStripped = n.value !== m, n.leftStripped;
    }
  }
  t.default = p, e.exports = t.default;
})(Fe, Fe.exports);
...
function An(e, t, r) {
  ...
  for (var l = e ? "@" : "", h = [], p = 0, s = 0, i = t.length; s < i; s++) {
    ...
    if (l += (t[s].separator || "") + c, !a && (c === ".." || c === "." || c === "this")) {
      if (h.length > 0)
        throw new Ze.default("Invalid path: " + l, { loc: r });
      c === ".." && p++;
    } else
      h.push(c);
  }
...
function On(e, t, r, l, h, p) {
  ...
  if (r) {
    ...
    r.chain && (r.program.body[0].closeStrip = l.strip), c = r.strip, i = r.program;
  }
...
function Rn(e, t) {
  if (!t && e.length) {
    var r = e[0].loc, l = e[e.length - 1].loc;
    r && l && (t = {
      source: r.source,
      start: {
        line: r.start.line,
...
function wt(e, t) {
  if (e.type === "Program")
    return e;
  He.default.yy = ue, ue.locInfo = function(l) {
    return new ue.SourceLocation(t && t.srcName, l);
  };
  var r = He.default.parse(e);
  return r;
}
function Vn(e, t) {
  var r = wt(e, t), l = new Bn.default(t);
  return l.accept(r);
}
var ne = {};
ne.__esModule = !0;
...
Ve.prototype = {
  ...
  equals: function(e) {
    ...
    if (e.opcodes.length !== t)
      return !1;
    for (var r = 0; r < t; r++) {
      var l = this.opcodes[r], h = e.opcodes[r];
      if (l.opcode !== h.opcode || !xt(l.args, h.args))
        return !1;
    }
  ...
  compileProgram: function(e) {
    var t = new this.compiler(), r = t.compile(e, this.options), l = this.guid++;
    return this.usePartial = this.usePartial || r.usePartial, this.children[l] = r, this.useDepths = this.useDepths || r.useDepths, l;
  },
  accept: function(e) {
    if (!this[e.type])
  ...
  Program: function(e) {
    ...
    for (var t = e.body, r = t.length, l = 0; l < r; l++)
      this.accept(t[l]);
  ...
  BlockStatement: function(e) {
    ...
    var l = this.classifySexpr(e);
    l === "helper" ? this.helperSexpr(e, t, r) : l === "simple" ? (this.simpleSexpr(e), this.opcode("pushProgram", t), this.opcode("pushProgram", r), this.opcode("emptyHash"), this.opcode("blockValue", e.path.original)) : (this.ambiguousSexpr(e, t, r), this.opcode("pushProgram", t), this.opcode("pushProgram", r), this.opcode("emptyHash"), this.opcode("ambiguousBlockValue")), this.opcode("append");
  },
  DecoratorBlock: function(e) {
    var t = e.program && this.compileProgram(e.program), r = this.setupFullMustacheParams(e, t, void 0), l = e.path;
    this.useDecorators = !0, this.opcode("registerDecorator", r.length, l.original);
  },
  PartialStatement: function(e) {
    ...
    var l = e.name.original, h = e.name.type === "SubExpression";
    h && this.accept(e.name), this.setupFullMustacheParams(e, t, void 0, !0);
    var p = e.indent || "";
    this.options.preventIndent && p && (this.opcode("appendContent", p), p = ""), this.opcode("invokePartial", h, l, p), this.opcode("append");
  },
  ...
  ambiguousSexpr: function(e, t, r) {
    var l = e.path, h = l.parts[0], p = t != null || r != null;
    this.opcode("getContext", l.depth), this.opcode("pushProgram", t), this.opcode("pushProgram", r), l.strict = !0, this.accept(l), this.opcode("invokeAmbiguous", h, p);
  },
  ...
  helperSexpr: function(e, t, r) {
    var l = this.setupFullMustacheParams(e, t, r), h = e.path, p = h.parts[0];
    if (this.options.knownHelpers[p])
      this.opcode("invokeKnownHelper", l.length, p);
    else {
      if (this.options.knownHelpersOnly)
        throw new Y.default("You specified knownHelpersOnly, but used the unknown helper " + p, e);
      h.strict = !0, h.falsy = !0, this.accept(h), this.opcode("invokeHelper", l.length, h.original, Z.default.helpers.simpleId(h));
    }
  },
  PathExpression: function(e) {
    this.addDepth(e.depth), this.opcode("getContext", e.depth);
    var t = e.parts[0], r = Z.default.helpers.scopedId(e), l = !e.depth && !r && this.blockParamIndex(t);
    l ? this.opcode("lookupBlockParam", l, e.parts) : t ? e.data ? (this.options.data = !0, this.opcode("lookupData", e.depth, e.parts, e.strict)) : this.opcode("lookupOnContext", e.parts, e.falsy, e.strict, r) : this.opcode("pushContext");
  },
  ...
  Hash: function(e) {
    var t = e.pairs, r = 0, l = t.length;
    for (this.opcode("pushHash"); r < l; r++)
  ...
  classifySexpr: function(e) {
    var t = Z.default.helpers.simpleId(e.path), r = t && !!this.blockParamIndex(e.path.parts[0]), l = !r && Z.default.helpers.helperExpression(e), h = !r && (l || t);
    if (h && !l) {
      var p = e.path.parts[0], s = this.options;
      s.knownHelpers[p] ? l = !0 : s.knownHelpersOnly && (h = !1);
    }
    return l ? "helper" : h ? "ambiguous" : "simple";
  },
    ...
    if (this.stringParams)
      ...
      if (this.trackIds) {
        ...
        if (e.parts && !Z.default.helpers.scopedId(e) && !e.depth && (r = this.blockParamIndex(e.parts[0])), r) {
          var l = e.parts.slice(1).join(".");
          this.opcode("pushId", "BlockParam", r, l);
        } else
  ...
  setupFullMustacheParams: function(e, t, r, l) {
    var h = e.params;
    return this.pushParams(h), this.opcode("pushProgram", t), this.opcode("pushProgram", r), e.hash ? this.accept(e.hash) : this.opcode("emptyHash", l), h;
  },
  blockParamIndex: function(e) {
    for (var t = 0, r = this.options.blockParams.length; t < r; t++) {
      var l = this.options.blockParams[t], h = l && ee.indexOf(l, e);
      if (l && h >= 0)
        return [t, h];
    }
  }
...
function Gn(e, t, r) {
  ...
  var l = r.parse(e, t), h = new r.Compiler().compile(l, t);
...
function qn(e, t, r) {
  ...
  var l = void 0;
  function h() {
    var s = r.parse(e, t), i = new r.Compiler().compile(s, t), c = new r.JavaScriptCompiler().compile(i, t, void 0, !0);
    return r.template(c);
  }
  function p(s, i) {
    return l || (l = h()), l.call(this, s, i);
  }
  return p._setup = function(s) {
    return l || (l = h()), l._setup(s);
  }, p._child = function(s, i, c, a) {
    return l || (l = h()), l._child(s, i, c, a);
  }, p;
}
function xt(e, t) {
  if (e === t)
...
function Kn() {
  ...
  return ae.encode = function(t) {
    ...
    var r = 65, l = 90, h = 97, p = 122, s = 48, i = 57, c = 43, a = 47, d = 26, o = 52;
    return r <= t && t <= l ? t - r : h <= t && t <= p ? t - h + d : s <= t && t <= i ? t - s + o : t == c ? 62 : t == a ? 63 : -1;
  }, ae;
}
var rt;
function Ct() {
  ...
  return se.encode = function(i) {
    var c = "", a, d = p(i);
    do
      a = d & l, d >>>= t, d > 0 && (a |= h), c += e.encode(a);
    while (d > 0);
    return c;
  }, se.decode = function(i, c, a) {
    var d = i.length, o = 0, u = 0, n, m;
    do {
      if (c >= d)
        throw new Error("Expected more digits in base 64 VLQ value.");
      if (m = e.decode(i.charCodeAt(c++)), m === -1)
        throw new Error("Invalid base64 digit: " + i.charAt(c - 1));
      n = !!(m & h), m &= l, o = o + (m << u), u += t;
    } while (n);
    a.value = s(o), a.rest = c;
  }, se;
}
var nt = {}, it;
function ie() {
...
function At() {
  ...
  return l.fromArray = function(h, p) {
    for (var s = new l(), i = 0, c = h.length; i < c; i++)
      s.add(h[i], p);
    return s;
  }, l.prototype.size = function() {
    return r ? this._set.size : Object.getOwnPropertyNames(this._set).length;
  }, l.prototype.add = function(h, p) {
    var s = r ? h : e.toSetString(h), i = r ? this.has(h) : t.call(this._set, s), c = this._array.length;
    (!i || p) && this._array.push(h), i || (r ? this._set.set(h, c) : this._set[s] = c);
  }, l.prototype.has = function(h) {
    if (r)
      return this._set.has(h);
    var p = e.toSetString(h);
    return t.call(this._set, p);
  }, l.prototype.indexOf = function(h) {
    if (r) {
...
function Wn() {
  ...
  var e = ie();
  function t(l, h) {
    var p = l.generatedLine, s = h.generatedLine, i = l.generatedColumn, c = h.generatedColumn;
    return s > p || s == p && c >= i || e.compareByGeneratedPositionsInflated(l, h) <= 0;
  }
  function r() {
    this._array = [], this._sorted = !0, this._last = { generatedLine: -1, generatedColumn: 0 };
  }
  return r.prototype.unsortedForEach = function(l, h) {
    this._array.forEach(l, h);
  }, r.prototype.add = function(l) {
    t(this._last, l) ? (this._last = l, this._array.push(l)) : (this._sorted = !1, this._array.push(l));
...
function Pt() {
  ...
  return h.prototype._version = 3, h.fromSourceMap = function(p) {
    ...
    return p.eachMapping(function(c) {
      ...
      c.source != null && (a.source = c.source, s != null && (a.source = t.relative(s, a.source)), a.original = {
        line: c.originalLine,
        column: c.originalColumn
      }, c.name != null && (a.name = c.name)), i.addMapping(a);
    }), p.sources.forEach(function(c) {
      var a = c;
      s !== null && (a = t.relative(s, c)), i._sources.has(a) || i._sources.add(a);
      var d = p.sourceContentFor(c);
      d != null && i.setSourceContent(c, d);
    }), i;
  }, h.prototype.addMapping = function(p) {
    var s = t.getArg(p, "generated"), i = t.getArg(p, "original", null), c = t.getArg(p, "source", null), a = t.getArg(p, "name", null);
    this._skipValidation || this._validateMapping(s, i, c, a), c != null && (c = String(c), this._sources.has(c) || this._sources.add(c)), a != null && (a = String(a), this._names.has(a) || this._names.add(a)), this._mappings.add({
    ...
    a != null && (c = t.relative(a, c));
    var d = new r(), o = new r();
    this._mappings.unsortedForEach(function(u) {
      if (u.source === c && u.originalLine != null) {
        var n = p.originalPositionFor({
          line: u.originalLine,
          column: u.originalColumn
        });
        n.source != null && (u.source = n.source, i != null && (u.source = t.join(i, u.source)), a != null && (u.source = t.relative(a, u.source)), u.originalLine = n.line, u.originalColumn = n.column, n.name != null && (u.name = n.name));
      }
      var m = u.source;
      m != null && !d.has(m) && d.add(m);
      var f = u.name;
      f != null && !o.has(f) && o.add(f);
    }, this), this._sources = d, this._names = o, p.sources.forEach(function(u) {
      var n = p.sourceContentFor(u);
      n != null && (i != null && (u = t.join(i, u)), a != null && (u = t.relative(a, u)), this.setSourceContent(u, n));
    }, this);
  }, h.prototype._validateMapping = function(p, s, i, c) {
    if (s && typeof s.line != "number" && typeof s.column != "number")
      throw new Error(
        "original.line and original.column are not numbers -- you probably meant to omit the original mapping entirely and only map the generated position. If so, pass null for the original mapping instead of an object with empty or null values."
      );
    if (!(p && "line" in p && "column" in p && p.line > 0 && p.column >= 0 && !s && !i && !c)) {
    ...
    for (var p = 0, s = 1, i = 0, c = 0, a = 0, d = 0, o = "", u, n, m, f, y = this._mappings.toArray(), v = 0, _ = y.length; v < _; v++) {
      if (n = y[v], u = "", n.generatedLine !== s)
      ...
      u += e.encode(n.generatedColumn - p), p = n.generatedColumn, n.source != null && (f = this._sources.indexOf(n.source), u += e.encode(f - d), d = f, u += e.encode(n.originalLine - 1 - c), c = n.originalLine - 1, u += e.encode(n.originalColumn - i), i = n.originalColumn, n.name != null && (m = this._names.indexOf(n.name), u += e.encode(m - a), a = m)), o += u;
    }
    return o;
...
function Zn() {
  return ut || (ut = 1, function(e) {
    ...
    function t(r, l, h, p, s, i) {
      var c = Math.floor((l - r) / 2) + r, a = s(h, p[c], !0);
      return a === 0 ? c : a > 0 ? l - c > 1 ? t(c, l, h, p, s, i) : i == e.LEAST_UPPER_BOUND ? l < p.length ? l : -1 : c : c - r > 1 ? t(r, c, h, p, s, i) : i == e.LEAST_UPPER_BOUND ? c : r < 0 ? -1 : r;
    }
    e.search = function(r, l, h, p) {
      if (l.length === 0)
        return -1;
      var s = t(
        -1,
...
function Jn() {
  ...
  function r(l, h, p, s) {
    if (p < s) {
      var i = t(p, s), c = p - 1;
      e(l, i, s);
      for (var a = l[s], d = p; d < s; d++)
        h(l[d], a) <= 0 && (c += 1, e(l, c, d));
      e(l, c + 1, d);
      var o = c + 1;
      r(l, h, p, o - 1), r(l, h, o + 1, s);
    }
  }
  return be.quickSort = function(l, h) {
    r(l, h, 0, l.length - 1);
  }, be;
}
var pt;
function Qn() {
  ...
  p.fromSourceMap = function(a, d) {
    ...
    var u = d || null, n = o || p.GENERATED_ORDER, m;
    switch (n) {
  ...
  function s(a, d) {
    ...
    var u = e.getArg(o, "version"), n = e.getArg(o, "sources"), m = e.getArg(o, "names", []), f = e.getArg(o, "sourceRoot", null), y = e.getArg(o, "sourcesContent", null), v = e.getArg(o, "mappings"), _ = e.getArg(o, "file", null);
    if (u != this._version)
  ...
  s.prototype = Object.create(p.prototype), s.prototype.consumer = p, s.prototype._findSourceIndex = function(a) {
    ...
    var o = Object.create(s.prototype), u = o._names = r.fromArray(a._names.toArray(), !0), n = o._sources = r.fromArray(a._sources.toArray(), !0);
    ...
    for (var m = a._mappings.toArray().slice(), f = o.__generatedMappings = [], y = o.__originalMappings = [], v = 0, _ = m.length; v < _; v++) {
      var b = m[v], g = new i();
      g.generatedLine = b.generatedLine, g.generatedColumn = b.generatedColumn, b.source && (g.source = n.indexOf(b.source), g.originalLine = b.originalLine, g.originalColumn = b.originalColumn, b.name && (g.name = u.indexOf(b.name)), y.push(g)), f.push(g);
    }
  ...
  s.prototype._parseMappings = function(a, d) {
    for (var o = 1, u = 0, n = 0, m = 0, f = 0, y = 0, v = a.length, _ = 0, b = {}, g = {}, S = [], E = [], k, w, L, A, O; _ < v; )
      if (a.charAt(_) === ";")
        ...
        k.generatedColumn = u + L[0], u = k.generatedColumn, L.length > 1 && (k.source = f + L[1], f += L[1], k.originalLine = n + L[2], n = k.originalLine, k.originalLine += 1, k.originalColumn = m + L[3], m = k.originalColumn, L.length > 4 && (k.name = y + L[4], y += L[4])), E.push(k), typeof k.originalLine == "number" && S.push(k);
      }
  ...
  }, s.prototype._findMapping = function(a, d, o, u, n, m) {
    if (a[o] <= 0)
      throw new TypeError("Line must be greater than or equal to 1, got " + a[o]);
    if (a[u] < 0)
      throw new TypeError("Column must be greater than or equal to 0, got " + a[u]);
    ...
    if (o >= 0) {
      var u = this._generatedMappings[o];
      if (u.generatedLine === d.generatedLine) {
        var n = e.getArg(u, "source", null);
    ...
    if (this.sourceRoot != null && (n = e.urlParse(this.sourceRoot))) {
      ...
      if ((!n.path || n.path == "/") && this._sources.has("/" + u))
    ...
    if (u >= 0) {
      var n = this._originalMappings[u];
  ...
  function c(a, d) {
    var o = a;
    typeof a == "string" && (o = e.parseSourceMapInput(a));
    var u = e.getArg(o, "version"), n = e.getArg(o, "sections");
    if (u != this._version)
      throw new Error("Unsupported version: " + u);
  ...
  return c.prototype = Object.create(p.prototype), c.prototype.constructor = p, c.prototype._version = 3, Object.defineProperty(c.prototype, "sources", {
  ...
  }), c.prototype.originalPositionFor = function(a) {
    var d = {
      generatedLine: e.getArg(a, "line"),
      generatedColumn: e.getArg(a, "column")
    }, o = t.search(
    ...
    return u ? u.consumer.originalPositionFor({
      line: d.generatedLine - (u.generatedOffset.generatedLine - 1),
      column: d.generatedColumn - (u.generatedOffset.generatedLine === d.generatedLine ? u.generatedOffset.generatedColumn - 1 : 0),
      bias: a.bias
    }) : {
      source: null,
      line: null,
  ...
  }, c.prototype.sourceContentFor = function(a, d) {
    for (var o = 0; o < this._sections.length; o++) {
      var u = this._sections[o], n = u.consumer.sourceContentFor(a, !0);
      if (n)
        return n;
    }
    if (d)
  ...
  }, c.prototype.generatedPositionFor = function(a) {
    for (var d = 0; d < this._sections.length; d++) {
      var o = this._sections[d];
      if (o.consumer._findSourceIndex(e.getArg(a, "source")) !== -1) {
        var u = o.consumer.generatedPositionFor(a);
        if (u) {
          var n = {
            line: u.line + (o.generatedOffset.generatedLine - 1),
            column: u.column + (o.generatedOffset.generatedLine === u.line ? o.generatedOffset.generatedColumn - 1 : 0)
          };
          return n;
        }
      }
  ...
  }, c.prototype._parseMappings = function(a, d) {
    this.__generatedMappings = [], this.__originalMappings = [];
    for (var o = 0; o < this._sections.length; o++)
      for (var u = this._sections[o], n = u.consumer._generatedMappings, m = 0; m < n.length; m++) {
        var f = n[m], y = u.consumer._sources.at(f.source);
        y = e.computeSourceURL(u.consumer.sourceRoot, y, this._sourceMapURL), this._sources.add(y), y = this._sources.indexOf(y);
        var v = null;
        f.name && (v = u.consumer._names.at(f.name), this._names.add(v), v = this._names.indexOf(v));
        var _ = {
          source: y,
          generatedLine: f.generatedLine + (u.generatedOffset.generatedLine - 1),
          generatedColumn: f.generatedColumn + (u.generatedOffset.generatedLine === f.generatedLine ? u.generatedOffset.generatedColumn - 1 : 0),
...
function Yn() {
  ...
  return p.fromStringWithSourceMap = function(s, i, c) {
    var a = new p(), d = s.split(r), o = 0, u = function() {
      var v = b(), _ = b() || "";
      return v + _;
      function b() {
    ...
    return i.eachMapping(function(v) {
      ...
      f = v;
    }, this), o < d.length && (f && y(f, u()), a.add(d.splice(o).join(""))), i.sources.forEach(function(v) {
      var _ = i.sourceContentFor(v);
      _ != null && (c != null && (v = t.join(c, v)), a.setSourceContent(v, _));
    }), a;
    function y(v, _) {
    ...
    for (var i, c = 0, a = this.children.length; c < a; c++)
      i = this.children[c], i[h] ? i.walk(s) : i !== "" && s(i, {
        source: this.source,
        line: this.line,
        column: this.column,
        name: this.name
    ...
    var i, c, a = this.children.length;
    if (a > 0) {
      for (i = [], c = 0; c < a - 1; c++)
        i.push(this.children[c]), i.push(s);
      i.push(this.children[c]), this.children = i;
    }
    return this;
  }, p.prototype.replaceRight = function(s, i) {
    var c = this.children[this.children.length - 1];
    return c[h] ? c.replaceRight(s, i) : typeof c == "string" ? this.children[this.children.length - 1] = c.replace(s, i) : this.children.push("".replace(s, i)), this;
    ...
    for (var a = Object.keys(this.sourceContents), i = 0, c = a.length; i < c; i++)
    ...
    var i = {
      ...
      line: 1,
      column: 0
    }, c = new e(s), a = !1, d = null, o = null, u = null, n = null;
    return this.walk(function(m, f) {
      i.code += m, f.source !== null && f.line !== null && f.column !== null ? ((d !== f.source || o !== f.line || u !== f.column || n !== f.name) && c.addMapping({
        source: f.source,
        original: {
          line: f.line,
          column: f.column
        ...
        name: f.name
      }), d = f.source, o = f.line, u = f.column, n = f.name, a = !0) : a && (c.addMapping({
        generated: {
          line: i.line,
          column: i.column
        }
      ...
      for (var y = 0, v = m.length; y < v; y++)
        m.charCodeAt(y) === l ? (i.line++, i.column = 0, y + 1 === v ? (d = null, a = !1) : a && c.addMapping({
          source: f.source,
          original: {
            line: f.line,
            column: f.column
...
(function(e, t) {
  ...
  function p(i, c, a) {
    if (r.isArray(i)) {
      for (var d = [], o = 0, u = i.length; o < u; o++)
        d.push(c.wrap(i[o], a));
      return d;
...
`]);
    ...
    each: function(i) {
      for (var c = 0, a = this.source.length; c < a; c++)
        i(this.source[c]);
    },
    empty: function() {
      var i = this.currentLocation || { start: {} };
      return new l(i.start.line, i.start.column, this.srcFile);
    },
    wrap: function(i) {
      var c = arguments.length <= 1 || arguments[1] === void 0 ? this.currentLocation || { start: {} } : arguments[1];
      return i instanceof l ? i : (i = p(i, this, c), new l(c.start.line, c.start.column, this.srcFile, i));
    },
    functionCall: function(i, c, a) {
      return a = this.generateList(a), this.wrap([i, c ? "." + c + "(" : "(", a, ")"]);
    },
    ...
    objectLiteral: function(i) {
      ...
      Object.keys(i).forEach(function(o) {
        var u = p(i[o], c);
        u !== "undefined" && a.push([c.quotedString(o), ":", u]);
      });
      var d = this.generateList(a);
      return d.prepend("{"), d.add("}"), d;
    },
    generateList: function(i) {
      for (var c = this.empty(), a = 0, d = i.length; a < d; a++)
        a && c.add(","), c.add(p(i[a], this));
      return c;
    },
...
(function(e, t) {
  ...
  var l = D, h = R.exports, p = r(h), s = x, i = je.exports, c = r(i);
  function a(u) {
    this.value = u;
  }
  function d() {
  ...
  d.prototype = {
    nameLookup: function(u, n) {
      return this.internalNameLookup(u, n);
    },
    depthedLookup: function(u) {
      return [this.aliasable("container.lookup"), "(depths, ", JSON.stringify(u), ")"];
    },
    compilerInfo: function() {
      var u = l.COMPILER_REVISION, n = l.REVISION_CHANGES[u];
      return [u, n];
    },
    appendToBuffer: function(u, n, m) {
      return s.isArray(u) || (u = [u]), u = this.source.wrap(u, n), this.environment.isSimple ? ["return ", u, ";"] : m ? ["buffer += ", u, ";"] : (u.appendToBuffer = !0, u);
    },
    initializeBuffer: function() {
      return this.quotedString("");
    },
    internalNameLookup: function(u, n) {
      return this.lookupPropertyFunctionIsUsed = !0, ["lookupProperty(", u, ",", JSON.stringify(n), ")"];
    },
    lookupPropertyFunctionIsUsed: !1,
    compile: function(u, n, m, f) {
      this.environment = u, this.options = n, this.stringParams = this.options.stringParams, this.trackIds = this.options.trackIds, this.precompile = !f, this.name = this.environment.name, this.isChild = !!m, this.context = m || {
        decorators: [],
        programs: [],
        environments: []
      }, this.preamble(), this.stackSlot = 0, this.stackVars = [], this.aliases = {}, this.registers = { list: [] }, this.hashes = [], this.compileStack = [], this.inlineStack = [], this.blockParams = [], this.compileChildren(u, n), this.useDepths = this.useDepths || u.useDepths || u.useDecorators || this.options.compat, this.useBlockParams = this.useBlockParams || u.useBlockParams;
      var y = u.opcodes, v = void 0, _ = void 0, b = void 0, g = void 0;
...
`), this.decorators = this.decorators.merge()));
    ...
    createFunctionContext: function(u) {
      ...
      return u ? (v.push(_), Function.apply(this, v)) : this.source.wrap(["function(", v.join(","), `) {
  `, _, "}"]);
    },
    mergeSource: function(u) {
      ...
      }), m ? v ? (v.prepend("return "), _.add(";")) : y || this.source.push('return "";') : (u += ", buffer = " + (f ? "" : this.initializeBuffer()), v ? (v.prepend("return buffer + "), _.add(";")) : this.source.push("return buffer;")), u && this.source.prepend("var " + u.substring(2) + (f ? "" : `;
`)), this.source.merge();
    },
    ...
    ambiguousBlockValue: function() {
      var u = this.aliasable("container.hooks.blockHelperMissing"), n = [this.contextName(0)];
      this.setupHelperArgs("", 0, n, !0), this.flushInline();
      var m = this.topStack();
      n.splice(1, 0, m), this.pushSource(["if (!", this.lastHelper, ") { ", m, " = ", this.source.functionCall(u, "call", n), "}"]);
    },
    ...
    lookupOnContext: function(u, n, m, f) {
      var y = 0;
      !f && this.options.compat && !this.lastContext ? this.push(this.depthedLookup(u[y++])) : this.pushContext(), this.resolvePath("context", u, y, n, m);
    },
    lookupBlockParam: function(u, n) {
      this.useBlockParams = !0, this.push(["blockParams[", u[0], "][", u[1], "]"]), this.resolvePath("context", n, 1);
    },
    lookupData: function(u, n, m) {
      u ? this.pushStackLiteral("container.data(data, " + u + ")") : this.pushStackLiteral("data"), this.resolvePath("data", n, 0, !0, m);
    },
    resolvePath: function(u, n, m, f, y) {
      var v = this;
      if (this.options.strict || this.options.assumeObjects) {
        this.push(o(this.options.strict && y, this, n, u));
        return;
      }
      for (var _ = n.length; m < _; m++)
        this.replaceStack(function(b) {
          var g = v.nameLookup(b, n[m], u);
          return f ? [" && ", g] : [" != null ? ", g, " : ", b];
        });
    },
    ...
    pushStringParam: function(u, n) {
      this.pushContext(), this.pushString(n), n !== "SubExpression" && (typeof u == "string" ? this.pushString(u) : this.pushStackLiteral(u));
    },
    ...
    registerDecorator: function(u, n) {
      var m = this.nameLookup("decorators", n, "decorator"), f = this.setupHelperArgs(n, u);
      this.decorators.push(["fn = ", this.decorators.functionCall(m, "", ["fn", "props", "container", f]), " || fn;"]);
    },
    invokeHelper: function(u, n, m) {
      var f = this.popStack(), y = this.setupHelper(u, n), v = [];
    ...
    invokeKnownHelper: function(u, n) {
      var m = this.setupHelper(u, n);
      this.push(this.source.functionCall(m.name, "call", m.callParams));
    },
    invokeAmbiguous: function(u, n) {
      this.useRegister("helper");
      var m = this.popStack();
      this.emptyHash();
      var f = this.setupHelper(0, u, n), y = this.lastHelper = this.nameLookup("helpers", u, "helper"), v = ["(", "(helper = ", y, " || ", m, ")"];
    ...
    assignToHash: function(u) {
      ...
      var v = this.hash;
      m && (v.contexts[u] = m), f && (v.types[u] = f), y && (v.ids[u] = y), v.values[u] = n;
    },
    pushId: function(u, n, m) {
      u === "BlockParam" ? this.pushStackLiteral("blockParams[" + n[0] + "].path[" + n[1] + "]" + (m ? " + " + JSON.stringify("." + m) : "")) : u === "PathExpression" ? this.pushString(n) : u === "SubExpression" ? this.pushStackLiteral("true") : this.pushStackLiteral("null");
    },
    compiler: d,
    compileChildren: function(u, n) {
      for (var m = u.children, f = void 0, y = void 0, v = 0, _ = m.length; v < _; v++) {
    ...
    programExpression: function(u) {
      var n = this.environment.children[u], m = [n.index, "data", n.blockParams];
    ...
    push: function(u) {
      return u instanceof a || (u = this.source.wrap(u)), this.inlineStack.push(u), u;
    },
    ...
    topStack: function() {
      var u = this.isInline() ? this.inlineStack : this.compileStack, n = u[u.length - 1];
    ...
    aliasable: function(u) {
      var n = this.aliases[u];
      return n ? (n.referenceCount++, n) : (n = this.aliases[u] = this.source.wrap(u), n.aliasable = !0, n.referenceCount = 1, n);
    },
    setupHelper: function(u, n, m) {
      var f = [], y = this.setupHelperArgs(n, u, f, m), v = this.nameLookup("helpers", n, "helper"), _ = this.aliasable(this.contextName(0) + " != null ? " + this.contextName(0) + " : (container.nullContext || {})");
      return {
        params: f,
        paramsInit: y,
        name: v,
    ...
    setupParams: function(u, n, m) {
      var f = {}, y = [], v = [], _ = [], b = !m, g = void 0;
      b && (m = []), f.name = this.quotedString(u), f.hash = this.popStack(), this.trackIds && (f.hashIds = this.popStack()), this.stringParams && (f.hashTypes = this.popStack(), f.hashContexts = this.popStack());
    ...
    setupHelperArgs: function(u, n, m, f) {
      var y = this.setupParams(u, n, m);
    ...
    for (var u = "break else new var case finally return void catch for switch while continue function this with default if throw delete in try do instanceof typeof abstract enum int short boolean export interface static byte extends long super char final native synchronized class float package throws const goto private transient debugger implements protected volatile double import public let yield await null true false".split(" "), n = d.RESERVED_WORDS = {}, m = 0, f = u.length; m < f; m++)
      n[u[m]] = !0;
  }(), d.isValidJavaScriptVariableName = function(u) {
    return !d.RESERVED_WORDS[u] && /^[a-zA-Z_$][0-9a-zA-Z_$]*$/.test(u);
  };
  function o(u, n, m, f) {
    var y = n.popStack(), v = 0, _ = m.length;
    for (u && _--; v < _; v++)
      y = n.nameLookup(y, m[v], f);
    return u ? [n.aliasable("container.strict"), "(", y, ", ", n.quotedString(m[v]), ", ", JSON.stringify(n.source.currentLocation), " )"] : y;
  }
...
(function(e, t) {
  ...
  var l = xe.exports, h = r(l), p = me.exports, s = r(p), i = re, c = ne, a = Ue.exports, d = r(a), o = fe.exports, u = r(o), n = de.exports, m = r(n), f = h.default.create;
  function y() {
    var _ = f();
    ...
    }, _.AST = s.default, _.Compiler = c.Compiler, _.JavaScriptCompiler = d.default, _.Parser = i.parser, _.parse = i.parse, _.parseWithoutProcessing = i.parseWithoutProcessing, _;
  }
  var v = y();
  v.create = y, m.default(v), v.Visitor = u.default, v.default = v, t.default = v, e.exports = t.default;
})(Le, Le.exports);
...
const ei = (e) => {
  var t;
  const r = e.opts;
  let l = "Ad {{adPosition}} of {{totalAds}} ends in {{secondsRemaining}}";
  r.adLabelNTime !== void 0 && (l = r.adLabelNTime), we === void 0 && (we = Mt.compile(l));
  ...
  var t;
  const r = e.opts;
  let l = "Ad ends in {{secondsRemaining}} seconds";
  r.adLabelTime !== void 0 && (l = r.adLabelTime), ke === void 0 && (ke = Mt.compile(l));
...
const ft = (e, t) => {
  ...
  const t = e.defaultUIElement, r = e.ui.root, l = e.ui.overlay;
  l.classList.add("overlay"), r.classList.add("ima-ui", "hidden"), t.after(r), e.ui.adContainer.classList.add("ad-container"), r.appendChild(e.ui.adContainer);
  const h = document.createElement("div");
  h.classList.add("animation"), e.ui.loadingSpinner.classList.add("loading-spinner", "hidden"), e.ui.loadingSpinner.appendChild(h), l.appendChild(e.ui.loadingSpinner), e.ui.controlsTop.classList.add("controls-top"), e.ui.controlsBottom.classList.add("controls-bottom"), l.appendChild(e.ui.controlsTop), l.appendChild(e.ui.controlsBottom), r.appendChild(l), ft(e, ze.LEFT).forEach((s) => {
...
class X {
  constructor() {
    M(this, "google"), M(this, "_dataStore"), M(this, "_chezaDataStore"), M(this, "logger"), M(this, "_onAdsManagerLoaded", (t) => {
      var r, l, h, p;
      const s = this._getGoogle(), i = (r = this._chezaDataStore) == null ? void 0 : r.videoElement, c = (l = this._dataStore.google) == null ? void 0 : l.ima.ViewMode.NORMAL, a = new s.ima.AdsRenderingSettings();
      ...
      const d = (h = (l = this._chezaDataStore) == null ? void 0 : l.videoElement.offsetWidth) != null ? h : 0, o = (s = (p = this._chezaDataStore) == null ? void 0 : p.videoElement.offsetHeight) != null ? s : 0;
      try {
      ...
      const u = this._chezaDataStore, n = u.videoElement, m = u.controlsBottom.querySelector(".button-play"), f = u.progressContainer;
  ...
  _getViewMode() {
    var t, r, l;
    return document.fullscreenElement === ((t = this._chezaDataStore) == null ? void 0 : t.rootElement) ? (r = this._dataStore.google) == null ? void 0 : r.ima.ViewMode.FULLSCREEN : (l = this._dataStore.google) == null ? void 0 : l.ima.ViewMode.NORMAL;
  }
  getDataStore() {
    return this._dataStore;
  }
  add(t, r) {
    this._dataStore.opts = r, this.logger = gt(r == null ? void 0 : r.debug), this._dataStore.videoElement = t.videoElement, this._chezaDataStore = t, this._dataStore.rootElement = t.rootElement, this._dataStore.defaultUIElement = t.uiRoot, si(this._dataStore), tr(r == null ? void 0 : r.debug).then((l) => {
      this._dataStore.google = l, this._loadIMAScriptCallback();
    }).catch((l) => {
      this.logger.error(l);
    });
  }
